...
public class HeadmasterExcel : MonoBehaviour
{
	...
	public void DropdownSetValue() {
		...
		/*IDs[0] = DropdownObj.value+8;
		IDs[1] = DropdownObj.value+7;
		IDs[2] = DropdownObj.value+6;
		IDs[3] = DropdownObj.value+5;
		IDs[4] = DropdownObj.value+4;
		IDs[5] = DropdownObj.value+3;
		IDs[6] = DropdownObj.value+2;
		IDs[7] = DropdownObj.value+1;
		IDs[8] = DropdownObj.value; */
