...
public class ShaderIndependentGlow : MonoBehaviour {
	...
	void OnRenderImage(RenderTexture src, RenderTexture dest) 
	{
        ...
        glowRT = RenderTexture.GetTemporary(src.width >> maskDownsample, src.height >> maskDownsample, 24, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default);
        ...
        blurRT = RenderTexture.GetTemporary(src.width, src.height, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default);
        ...
        RenderTexture tempRT = RenderTexture.GetTemporary(src.width,src.height, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Default);

		switch (debugMode)
		{
		case DebugModes.normal:
            Graphics.Blit(src,tempRT,composeMaterial);
